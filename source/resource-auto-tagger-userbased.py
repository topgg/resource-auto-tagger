...
# User-based AWS resource tagger run by AWS Lambda  基于用户的 Auto-tagger

# Import AWS modules for python 引入 AWS 模块函数
import botocore
import boto3
# Import JSON 引入JSON函数
import json
# Import RegEx module 引入正则表达式函数
import re
